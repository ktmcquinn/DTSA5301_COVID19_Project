...
In this case, my conclusion is that, globally, there is a very, very small correlation between country GDP per capita and COVID-19 death rate. It was really interesting to see that it wasn't as dramatic of a curve as I would've expected. It also seems that there is a correlation between the population density of any given county in the US and its COVID-19 death rate. 

As far as possible biases go, it's extremely difficult to analyze a dataset we ourselves are a part of. Since all of us have first-hand experience watching how COVID-19 has swept through the world, we tend to ask certain questions. Our experiences inform our analysis, so it's basically impossible to approach this project without biases. One bias in particular that I am now aware of is that I just assumed that we'd have some sort of dramatic death rate in lower-GDP countries. There are so many variables in contracting and surviving from COVID.
